"""
UN M49 Numeric → ISO 3166-1 Alpha-3 Code Mapping
==================================================

Used by the FAOSTAT food price ingestion pipeline to convert
M49 numeric area codes to ISO3 for crosswalk to GW codes.
...
M49_TO_ISO3 = {
    ...
    # Territories that appear in FAOSTAT
    275: "PSE",  # Palestine
    158: "TWN",  # Taiwan
    344: "HKG",  # Hong Kong
    446: "MAC",  # Macao
